  ...
  <div class="con_top">
       <div class="con_top_fix">
           ...
           <div class="con_top_left_matter">Fill out basic some information before you continue.</div>
            <div class="next"><img src="/Digitizationofcommunities/web/images/h.png" width="177" height="30" usemap="#Map" border="0">
               <map name="Map">
               
                 <area shape="rect" coords="26,1,98,24" href="/Digitizationofcommunities/education"  style="border:0px">
                   <area shape="rect" coords="95,4,167,27" href="/Digitizationofcommunities/career"  style="border:0px">
               </map>
           </div>
						...
						<option value='-1'>---Select location---</option>
							...
							<form:option value="PM">PM</form:option>
                                 ...
                                 <div class="clear"></div>
                                  <div class="link_bg">
                                <!------------------- ** Skip Section Open ** ----------------------------->
                                <a href="/Digitizationofcommunities/dashboard" title="Skip"><div class="skip"></div></a>
                                <!------------------- ** Skip Section Closed ** --------------------------->
